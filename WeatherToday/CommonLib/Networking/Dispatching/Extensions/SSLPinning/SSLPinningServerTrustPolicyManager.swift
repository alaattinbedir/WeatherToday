//
//  SSLPinningServerTrustPolicyManager.swift
//  WeatherToday
//
...
public class SSLPinnigServerTrustPolicyManager {
    /// The dictionary of policies mapped to a particular host.
    public let policies: [String: SSLPinnigServerTrustPolicy]
    ...
    public init(policies: [String: SSLPinnigServerTrustPolicy]) {
    ...
    open func serverTrustPolicy(forHost host: String) -> SSLPinnigServerTrustPolicy? {
...
public enum SSLPinnigServerTrustPolicy {
    ...
    public func evaluate(_ serverTrust: SecTrust, forHost host: String) -> Bool {
        ...
        case let .pinPublicKeys(pinnedPublicKeys, validateCertificateChain, validateHost):
            ...
            if certificateChainEvaluationPassed {
                outerLoop: for serverPublicKey in SSLPinnigServerTrustPolicy
                    .publicKeys(for: serverTrust) as [AnyObject] {
